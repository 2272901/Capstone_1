                        ...
                        <form method="post" action="<?php echo e(route('user-store')); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="user-email" placeholder="Contoh: jdoe@domain.com"
                                       required name="name" maxlength="100">
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\AWP\project-03\resources\views/user/create.blade.php ENDPATH**/ ?>