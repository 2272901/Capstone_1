            ...
            <div class="container-fluid">
                <div class="card p-4">
                    ...
                    <div class="card-header">
                        <a href="<?php echo e(route('user-create')); ?>" role="button" class="btn btn-success">Tambah User</a>
                    </div>
                    <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\AWP\project-03\resources\views/user/index.blade.php ENDPATH**/ ?>