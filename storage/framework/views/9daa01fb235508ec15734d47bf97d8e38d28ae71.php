            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        <?php if(\Illuminate\Support\Facades\Request::hasAny("kk")): ?>
                            <b>Hello</b>
                        <?php endif; ?>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('kk-list')); ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('ctz-list')); ?>" class="nav-link">
...
<?php /**PATH D:\AWP\project-03\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>